var spine = (() => {
  ...
  var THREE = __toModule(__require("three"));
  ...
  var THREE2 = __toModule(__require("three"));
      ...
      for (let i = 0, n = drawOrder.length; i < n; i++) {
        ...
        if (texture != null) {
          ...
          if (clipper.isClipping()) {
            ...
            if (this.vertexEffect != null) {
              let vertexEffect = this.vertexEffect;
              for (let v = 0, u = 0, n2 = numFloats; v < n2; v += vertexSize, u += 2) {
                tempPos.x = verts[v];
                tempPos.y = verts[v + 1];
                tempLight.setFromColor(color);
                tempDark.set(0, 0, 0, 0);
  ...
  var THREE3 = __toModule(__require("three"));
    ...
    findMaterialGroup(slotTexture, slotBlendMode) {
      ...
      if (Array.isArray(this.material)) {
        for (let i = 0; i < this.material.length; i++) {
          ...
          if (meshMaterial2.uniforms.map.value === null) {
